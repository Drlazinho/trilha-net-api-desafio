...
namespace TrilhaApiDesafio.Controllers
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        [HttpGet("ResumoContagem")]
        public IActionResult ResumoContagem()
        {
            var total = _context.Tarefas.Count();
            var pendentes = _context.Tarefas.Count(t => t.Status == EnumStatusTarefa.Pendente);
            var finalizadas = _context.Tarefas.Count(t => t.Status == EnumStatusTarefa.Finalizado);
